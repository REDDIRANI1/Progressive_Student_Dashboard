...
from app import db
from app.models import Lesson, LessonProgress, ActivityEvent, Enrollment, Course
...
def get_lesson(lesson_id):
    ...
    progress = LessonProgress.query.filter_by(student_id=identity['id'], lesson_id=lesson.id).first()
...
def complete_lesson(lesson_id):
    ...
    time_spent = data.get('timeSpentMinutes', lesson.estimated_minutes)
